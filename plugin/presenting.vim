...
let g:presenting_font_large = get(g:, 'presenting_font_large', 'banner3')
let g:presenting_font_small = get(g:, 'presenting_font_small', 'banner')

let g:presenting_center_titles = get(g:, 'presenting_center_titles', 0)
